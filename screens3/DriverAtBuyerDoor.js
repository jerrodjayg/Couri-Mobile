...
export default function DriverAtBuyerDoor({ navigation, route }) {
  ...
  const loadUserProfile = async () => {
    try {
      ...
      if (routeUserProfile) {
        ...
        console.log('✅ DriverAtBuyerDoor - Loaded user profile from route params');
        return;
      }
      ...
      if (storedProfile || tempUserData) {
        ...
        console.log('✅ DriverAtBuyerDoor - Loaded user profile from AsyncStorage:', mergedProfile);
  ...
  // Handle I'm at your door button
  const handleAtDoor = () => {
    // Navigate to HandtoBuyer screen
    navigation.navigate('HandtoBuyer', {
      deliveryPhotoUri,
      productDetails,
      orderDetails,
      userProfile,
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.title}>Park and head to the{'\n'}buyer's front door</Text>
          <Text style={styles.description}>
            Place the product in a Couri delivery bag, then head to the front door and tap "I'm at your door". Feel free to knock or ring their doorbell as well.
          </Text>

          {/* I'm at your door Button */}
          <TouchableOpacity 
            style={styles.doorButton}
            onPress={handleAtDoor}
          >
            <Text style={styles.doorButtonText}>I'm at your door</Text>
          </TouchableOpacity>
        </View>
